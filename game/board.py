...
class Board:
    ...
    def possible_h_wall(self, i, j):
        ...
        return (self.walls_h[i,j] == 0 and (j==0 or self.walls_h[i,j-1]==0) and  self.walls_v[i,j] == 0)

    def possible_v_wall(self, i, j):
        # TODO : utiliser wall_size pour ne pas checker que des murs de taille 2
        return (self.walls_v[i,j] == 0 and (i==0 or self.walls_v[i-1,j]==0) and self.walls_h[i, j] == 0)
